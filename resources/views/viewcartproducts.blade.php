                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{route('cartproducts')}}" class="nav-item nav-link active">Shopping Cart</a>
                            ...
                            @foreach($cart as $cartItem)
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <img src="{{ asset('products/'.$cartItem->product->product_image) }}" alt="{{ $cartItem->product->product_title }}" style="width: 50px; height: 50px; object-fit: contain;">
                                    ...
                                    <td class="align-middle">${{ number_format($cartItem->product->product_price, 2) }}</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                            <input type="text" class="form-control form-control-sm bg-secondary text-center" value="{{ $cartItem->quantity }}" readonly>
                                        </div>
                                    </td>
                                    <td class="align-middle">${{ number_format($itemTotal, 2) }}</td>
                                    <td class="align-middle">
                                        <a href="{{route('removecartproduct' , $cartItem->id)}}" class="btn btn-sm btn-primary" >
                        ...
                        @else
                            <tr>
                                <td colspan="5" class="text-center py-4">
                                    ...
                                    <a href="{{ route('allproduct') }}" class="btn btn-primary mt-2">Continue Shopping</a>
                                </td>
                            </tr>
                        @endif
                    </tbody>
