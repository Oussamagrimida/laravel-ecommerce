...
middleware(['auth', 'verified'])->name('cartproducts');
Route::get('/removecartproduct/{id}', [UserController::class , 'removeCartProduct'] )->
middleware(['auth', 'verified'])->name('removecartproduct');
...
Route::middleware('admin')->group(function () {
    ...
    Route::post('/update_category/{id}', [AdminController::class, 'editCategory'])->name('admin.editcategory');
    ...
    Route::post('/update_product/{id}', [AdminController::class, 'editProduct'])->name('admin.editproduct');
